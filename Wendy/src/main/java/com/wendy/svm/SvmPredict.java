...
import com.wendy.svm.libsvm.SVM;
import com.wendy.svm.libsvm.SvmModel;
import com.wendy.svm.libsvm.SvmNode;
import com.wendy.svm.libsvm.SvmParameter;
...
class SvmPredict {
	...
	private static void predict(BufferedReader input, DataOutputStream output, SvmModel model, int predict_probability) throws IOException
	{
		...
		else
		{
            ...
            String result = "Accuracy = "+(double)correct/total*100+ "% (" + correct + "/" + total+") (classification)\n";
		}
	}
