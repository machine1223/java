			...
			.add(
					...
					function(i) {
						var j = !i.config.flashEmbedTagOnly, k = i.config.flashAddEmbedTag
								|| i.config.flashEmbedTagOnly, l, m = '<div>'
								+ CKEDITOR.tools
										.htmlEncode(i.lang.common.preview)
								+ '<br>'
						...
						return {
							...
							onShow : function() {
								...
								l = new CKEDITOR.dom.element('embed',
										i.document);
														...
														children : [
																{
																	...
																	validate : CKEDITOR.dialog.validate
																			.notEmpty(i.lang.flash.validateSrc),
																	setup : g,
																	commit : h,
																	onLoad : function() {
																		var n = this
													...
													children : [
															{
																...
																id : 'width',
																style : 'width:95px',
																label : i.lang.flash.width,
																validate : CKEDITOR.dialog.validate
																		.integer(i.lang.flash.validateWidth),
																setup : function(
																		n, o,
																		p, q) {
																	g
															...
															},
															{
																...
																id : 'height',
																style : 'width:95px',
																label : i.lang.flash.height,
																validate : CKEDITOR.dialog.validate
																		.integer(i.lang.flash.validateHeight),
																setup : function(
																		n, o,
																		p, q) {
																	g
															...
															},
															{
																...
																validate : CKEDITOR.dialog.validate
																		.integer(i.lang.flash.validateHSpace),
																setup : g,
																commit : h
															},
															{
																...
																validate : CKEDITOR.dialog.validate
																		.integer(i.lang.flash.validateVSpace),
																setup : g,
																commit : h
															} ]
												}, {
										...
										elements : [
													...
													children : [
															{
																...
																items : [
																		[
																				...
																				'' ],
																		[
																				i.lang.flash.scaleAll,
																				'showall' ],
																		[
																				i.lang.flash.scaleNoBorder,
																				'noborder' ],
																		[
																				i.lang.flash.scaleFit,
																				'exactfit' ] ],
																setup : g,
																commit : h
															},
															{
																...
																items : [
																		[
																				...
																				'' ],
																		[
																				i.lang.flash.accessAlways,
																				'always' ],
																		[
																				i.lang.flash.accessSameDomain,
																				'samedomain' ],
																		[
																				i.lang.flash.accessNever,
																				'never' ] ],
																setup : g,
																commit : h
															} ]
													...
													children : [
															{
																...
																items : [
																		[
																				...
																				'' ],
																		[
																				i.lang.flash.windowModeWindow,
																				'window' ],
																		[
																				i.lang.flash.windowModeOpaque,
																				'opaque' ],
																		[
																				i.lang.flash.windowModeTransparent,
																				'transparent' ] ],
																setup : g,
																commit : h
															},
															{
																...
																items : [
																		[
																				...
																				'' ],
																		[
																				i.lang.flash.qualityBest,
																				'best' ],
																		[
																				i.lang.flash.qualityHigh,
																				'high' ],
																		[
																				i.lang.flash.qualityAutoHigh,
																				'autohigh' ],
																		[
																				i.lang.flash.qualityMedium,
																				'medium' ],
																		[
																				i.lang.flash.qualityAutoLow,
																				'autolow' ],
																		[
																				i.lang.flash.qualityLow,
																				'low' ] ],
																setup : g,
																commit : h
															} ]
													...
													children : [
															{
																...
																items : [
																		[
																				...
																				'' ],
																		[
																				i.lang.flash.alignLeft,
																				'left' ],
																		[
																				i.lang.flash.alignAbsBottom,
																				'absBottom' ],
																		[
																				i.lang.flash.alignAbsMiddle,
																				'absMiddle' ],
																		[
																				i.lang.flash.alignBaseline,
																				'baseline' ],
																		[
																				i.lang.flash.alignBottom,
																				'bottom' ],
																		[
																				i.lang.flash.alignMiddle,
																				'middle' ],
																		[
																				i.lang.flash.alignRight,
																				'right' ],
																		[
																				i.lang.flash.alignTextTop,
																				'textTop' ],
																		[
																				i.lang.flash.alignTop,
																				'top' ] ],
																setup : g,
																commit : function(
																		n, o,
												...
												},
												{
													...
													label : CKEDITOR.tools
															.htmlEncode(i.lang.flash.flashvars),
													children : [ {
														type : 'vbox',
														padding : 0,
														children : [
