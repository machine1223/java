...
(function () {
	var a = function (b, c) {
		...
		}}, {type:"hbox", widths:["140px", "240px"], children:[{type:"vbox", padding:10, children:[{type:"hbox", widths:["70%", "30%"], children:[{type:"vbox", padding:1, children:[{type:"text", width:"40px", id:"txtWidth", labelLayout:"horizontal", label:b.lang.image.width, onKeyUp:k, onChange:function () {
		...
		}}, {id:"cmbAlign", type:"select", labelLayout:"horizontal", widths:["35%", "65%"], style:"width:90px", label:b.lang.image.align, "default":"", items:[[b.lang.common.notSet, ""], [b.lang.image.alignLeft, "left"], [b.lang.image.alignRight, "right"]], onChange:function () {
			l(this.getDialog());
			o.call(this, "advanced:txtdlgGenStyle");
		}, setup:function (C, D) {
			if (C == d) {
		...
		}}]}, {id:"Upload", hidden:true, filebrowser:"uploadButton", label:b.lang.image.upload, elements:[{type:"file", id:"upload", label:b.lang.image.btnUpload, style:"height:40px", size:38}, {type:"fileButton", id:"uploadButton", filebrowser:"info:txtUrl", label:b.lang.image.btnUpload, onClick: function(){var d = this.getDialog();var _photo =  d.getContentElement('Upload','upload');var imgName = _photo.getValue();var types = "jpg,png,gif,bmp";var imgType = imgName.substring(imgName.lastIndexOf('.')+1);if(types.indexOf(imgType.toLowerCase()) == -1){alert("只能上传jpg,png,gif,bmp类型的图片");return false;}}, "for":["Upload", "upload"]}]}, {id:"advanced", label:b.lang.common.advancedTab, elements:[{type:"hbox", widths:["50%", "25%", "25%"], children:[{type:"text", id:"linkId", label:b.lang.common.id, setup:function (C, D) {
			if (C == d) {
